...
sed -i -e "s/;date.timezone\s=/date.timezone = UTC/g" /etc/php/7.1/fpm/php.ini
...
sed -i -e "s/;catch_workers_output\s*=\s*yes/catch_workers_output = yes/g" /etc/php/7.1/fpm/pool.d/www.conf
sed -i -e "s/listen\s=\s\/run\/php\/php7.1-fpm.sock/listen = \/var\/run\/php-fpm.sock/g" /etc/php/7.1/fpm/pool.d/www.conf
